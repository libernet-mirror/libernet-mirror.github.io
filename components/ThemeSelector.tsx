...
const LightIcon = (props: ComponentPropsWithoutRef<"svg">) => (
...
const DarkIcon = (props: ComponentPropsWithoutRef<"svg">) => (
  <svg viewBox="0 0 16 16" {...props}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
const SystemIcon = (props: ComponentPropsWithoutRef<"svg">) => (
  <svg viewBox="0 0 16 16" {...props}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export function ThemeSelector(
  ...
  return (
    <Listbox as="div" value={theme} onChange={setTheme} {...props}>
      ...
      <ListboxButton className="flex h-6 w-6 items-center justify-center rounded-lg shadow-md ring-1 shadow-black/5 ring-black/5 dark:bg-slate-700 dark:ring-white/5 dark:ring-inset">
        <LightIcon
          className={clsx(
            "h-4 w-4 dark:hidden",
